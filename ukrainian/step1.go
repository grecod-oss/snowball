...
func step1(word *snowballword.SnowballWord) bool {
	...
	suffix, _ := word.RemoveFirstSuffixIn(word.RVstart,
		...
		"альник", "ильник", "ільник", "аль", "ен",
		"ець", "єць", "ість", "тель", "инн", "иння", "інн", "іння",
		"анн", "янн", "яння", "енн", "ення", "ен", "еня", "єн",
		"ечок", "єчок", "ечк", "ичок", "ичка", "ик", "иц", "иця",
		"енк", "енко", "єнк", "еньк", "єньк", "иськ", "їськ", "ищ",
		"ище", "їщ", "їще", "ович", "івн", "ївн", "івк", "івка", "ївк",
